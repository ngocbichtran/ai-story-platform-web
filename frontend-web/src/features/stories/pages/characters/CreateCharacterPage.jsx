...
import { ArrowLeft, Save, User, BadgeInfo, Eye, BookOpen, Target, Users, Trash2, Plus, X, Pencil, Zap, TrendingUp, Tag } from "lucide-react";
...
export default function CreateCharacterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log("🔥 PAYLOAD TẠO NHÂN VẬT:", payload);
                                ...
                                <div className="grid gap-5 lg:grid-cols-12 w-full">
                                    ...
                                    <section className="lg:col-span-4 rounded-2xl border border-blue-500/10 bg-slate-950/30 p-5 shadow-sm flex flex-col gap-4">
                                        ...
                                        <div className="space-y-3.5 text-sm">
                                            ...
                                            {/* LOÀI */}
                                            <div className="flex flex-col gap-1.5">
                                                <label className="text-xs font-semibold uppercase tracking-wider text-slate-400">Loài</label>

                                                <input type="text" name="species" value={formData.species} onChange={handleChange} placeholder="Ví dụ: Người, Mèo, Chó, Tiên..." className="w-full bg-slate-950/50 border border-white/10 rounded-xl px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition placeholder-slate-600" />
                                            </div>
