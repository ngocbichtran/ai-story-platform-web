...
export default function EditCharacterPage() {
    ...
    // 1. Lấy danh sách nhân vật để liên kết (loại trừ chính nhân vật hiện tại)
    useEffect(() => {
    ...
    // 2. Lấy chi tiết dữ liệu nhân vật cũ để điền vào form
    useEffect(() => {
    ...
    const handleEditRelationshipClick = (item) => {
        ...
        setModalData({
            selectedCharId: targetRelId.toString(),
                    ...
                    <div className="grid grid-cols-12 items-center gap-3 p-2 relative z-10 w-full">
                        ...
                        <div className="col-span-12 md:col-span-4 flex items-center gap-3 rounded-xl border border-white/5 bg-slate-950/30 p-2">
                            ...
                            <div className="min-w-0 flex-1">
                                <h1 className="truncate text-lg font-black">{formData.name ? formData.name : "Chỉnh sửa nhân vật"}</h1>
                            </div>
                        </div>
